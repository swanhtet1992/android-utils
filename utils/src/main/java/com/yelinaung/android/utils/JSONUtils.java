...
public class JSONUtils {
    ...
    public String to_s(JSONObject mJsonObject, String mString) throws JSONException {
    ...
    public String to_s(JSONArray mJsonArray, int position, String mString) throws JSONException {
    ...
    public int to_i(JSONObject mJsonObject, String mString) throws JSONException {
        if (mJsonObject.has(mString)) {
    ...
    public int to_i(JSONArray mJsonArray, int position, String mString) throws JSONException {
        if (mJsonArray.getJSONObject(position).has(mString)) {
    ...
    public Long to_l(JSONObject mJsonObject, String mString) throws JSONException {
        if (mJsonObject.has(mString)) {
    ...
    public Long to_l(JSONArray mJsonArray, int position, String mString) throws JSONException {
        if (mJsonArray.getJSONObject(position).has(mString)) {
